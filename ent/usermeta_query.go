...
func (umq *UserMetaQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (umq *UserMetaQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (umq *UserMetaQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (umq *UserMetaQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (umq *UserMetaQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
...
func (umq *UserMetaQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := umq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(usermeta.FieldEmailNotification).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
//
//	client.UserMeta.Query().
//		Select(usermeta.FieldEmailNotification).
//		Scan(ctx, &v)
//
...
func (umq *UserMetaQuery) sqlAll(ctx context.Context) ([]*UserMeta, error) {
	...
	if query := umq.withUser; query != nil {
		...
		nodeids := make(map[uuid.UUID][]*UserMeta)
		for i := range nodes {
...
func (umq *UserMetaQuery) sqlQuery() *sql.Selector {
...
func (umgb *UserMetaGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(umgb.fields) > 1 {
		return nil, errors.New("ent: UserMetaGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := umgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (umgb *UserMetaGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{usermeta.Label}
	default:
		err = fmt.Errorf("ent: UserMetaGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (umgb *UserMetaGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(umgb.fields) > 1 {
		return nil, errors.New("ent: UserMetaGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := umgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (umgb *UserMetaGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{usermeta.Label}
	default:
		err = fmt.Errorf("ent: UserMetaGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (umgb *UserMetaGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(umgb.fields) > 1 {
		return nil, errors.New("ent: UserMetaGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := umgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (umgb *UserMetaGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{usermeta.Label}
	default:
		err = fmt.Errorf("ent: UserMetaGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (umgb *UserMetaGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(umgb.fields) > 1 {
		return nil, errors.New("ent: UserMetaGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := umgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (umgb *UserMetaGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{usermeta.Label}
	default:
		err = fmt.Errorf("ent: UserMetaGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ums *UserMetaSelect) Scan(ctx context.Context, v interface{}) error {
	...
	ums.sql = ums.UserMetaQuery.sqlQuery()
...
func (ums *UserMetaSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ums.fields) > 1 {
		return nil, errors.New("ent: UserMetaSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ums.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ums *UserMetaSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{usermeta.Label}
	default:
		err = fmt.Errorf("ent: UserMetaSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ums *UserMetaSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ums.fields) > 1 {
		return nil, errors.New("ent: UserMetaSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ums.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ums *UserMetaSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{usermeta.Label}
	default:
		err = fmt.Errorf("ent: UserMetaSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ums *UserMetaSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ums.fields) > 1 {
		return nil, errors.New("ent: UserMetaSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ums.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ums *UserMetaSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{usermeta.Label}
	default:
		err = fmt.Errorf("ent: UserMetaSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ums *UserMetaSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ums.fields) > 1 {
		return nil, errors.New("ent: UserMetaSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ums.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ums *UserMetaSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{usermeta.Label}
	default:
		err = fmt.Errorf("ent: UserMetaSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
