...
//		Scan(ctx, &v)
//
func (upq *UserProfileQuery) Select(field string, fields ...string) *UserProfileSelect {
...
func (upq *UserProfileQuery) sqlQuery() *sql.Selector {
...
func (ups *UserProfileSelect) Scan(ctx context.Context, v interface{}) error {
	...
	ups.sql = ups.UserProfileQuery.sqlQuery()
...
func (ups *UserProfileSelect) sqlQuery() sql.Querier {
	selector := ups.sql
